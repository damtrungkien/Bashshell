#!/bin/bash
path_domain="/home/trungkien/domains/damtrungkien.com/public_html/"  ### Nhập đường dẫn root website
main_sitemap="https://damtrungkien.com/sitemap_index.xml"            ### Nhập url sitemap
...
# Làm rỗng file curl.log
echo > $path_domain/curl.log